...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getEvents() async{
    DocumentSnapshot userDocumentSnaphot= await FirebaseFirestore.instance.collection('event').doc('EventDetails').get();
    if(userDocumentSnaphot.exists){
      setState(() {
        eventDetails = userDocumentSnaphot.get('events');
      });
    }
    print(eventDetails);
  }
